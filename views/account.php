...
<section id="register">
    ...
    <form action method="POST">
        <input type="text" id="fname" name="fname" required maxlength="18" placeholder="first name" value="<?php echo value('fname'); ?>" autocomplete="first-name">
        <input type="text" id="lname" name="lname" required maxlength="18" placeholder="last name" value="<?php echo value('lname'); ?>" autocomplete="last-name"><br>
        <input type="tel" id="tel" name="tel" required maxlength="18" placeholder="tel" value="<?php echo value('tel'); ?>" pattern="[+][0-9].{5,}" title="phone with country code ex: +1234567890" oninvalid="setCustomValidity('phone with country code ex: +1234567890')" onchange="try{setCustomValidity('')}catch(e){}" autocomplete="tel"><br>
